...
import getalp.wsd.ufsac.utils.PercentProgressDisplayer;
import getalp.wsd.ufsac.utils.tuples.Triplet;
...
public class OntonotesConverter
{
    ...
    private void loadOnf(String path, StreamingCorpusWriterSentence out, Map<Integer, Map<Integer, Triplet<String, String, String>>> senseMap, Map<String, List<String>> senseMapWN) throws Exception
    {
        BufferedReader br = new BufferedReader(new FileReader(path));
        String line;
